layui.define(['table', 'form', "common", "layedit"], function (exports) {
    ...
    table.render({
        ...
        url: "system/branchTopic/selectPages",
        method: "POST",
        where: {"type": 10,"companyType":1},
        cols: [[
            {type:'checkbox'},
    ...
    table.on('tool(LAY-user-manage)', function (obj) {
        ...
        if (obj.event === 'search') {
            layer.open({
                ...
                , maxmin: true
                , title: "查看问题"
                , content: 'system/branchTopic/insertOrEditInit?topicId=' + data.id +"&type=10&companyType=1"
            });
        } else if (obj.event === 'del') {
            layer.confirm('确认删除？', function () {
                $.ajax({
                    url: "system/branchTopic/delTopic",
                    method: "POST",
                    data: {id: data.id},
